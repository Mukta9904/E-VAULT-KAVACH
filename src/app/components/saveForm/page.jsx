  ...
  return (
    <div className="flex lg:w-[550px] w-full my-3 sticky top-20 mx-3 transition-all  rounded-[60px] bg-[#f2eae5e6]  h-full">
      ...
      >
        ...
        className={value.show?"h-6 w-6 absolute z-10 top-9 hover:scale-110 right-1 hover:cursor-pointer" : "hidden"}
        fill="none"
        viewBox="0 0 24 24"
        stroke="black"
        strokeWidth={2}
      ...
      >
        ...
        <div className="mb-1">
          ...
          <div className="flex gap-2 relative">
            ...
            <svg
        xmlns="http://www.w3.org/2000/svg"
        className={value.show?"h-6 w-6 absolute z-10 top-2 right-[75px] hover:scale-110  hover:cursor-pointer" : "hidden"}
        fill="none"
        viewBox="0 0 24 24"
        stroke="black"
        strokeWidth={2}
